...
p=s.cd()
o=p!==0?A.kE(n.a,s,p,"closing database",null,null):null
...
B.b.p(k,A.nE(new A.fG(h,l,f,Math.min(4096,A.d(m.length)-f)),e))
s=4
break
case 5:s=7
...
break
case 3:s=5
return A.f(A.aI(A.o(n.delete(q.dX(b,B.c.E(c,4096)*4096+1))),t.X),$async$ag)

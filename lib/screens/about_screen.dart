        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('À propos',
                  style: TextStyle(fontSize: 32, fontWeight: FontWeight.w600, color: Color(0xFF1A1A1A))),
              const SizedBox(height: 24),
              _Carte(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _LigneInfo(icone: Icons.school_outlined, label: 'Module',
                        valeur: 'Développement Multiplateforme · ESMT Dakar'),
                    const SizedBox(height: 12),
                    _LigneInfo(icone: Icons.flag_outlined, label: 'ODD',
                        valeur: 'ODD 5 — Égalité entre les sexes'),
                    const SizedBox(height: 12),
                    _LigneInfo(icone: Icons.phone_android_outlined, label: 'Application',
              ...
              _Carte(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Source des données',
                        style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Color(0xFF1A1A1A))),
                    const SizedBox(height: 12),
                    _LigneInfo(icone: Icons.link_outlined, label: 'Site',
                        valeur: 'jolofteranga.com/collections/plantes-medicinales'),
                    const SizedBox(height: 12),
                    _LigneInfo(icone: Icons.store_outlined, label: 'Source',
                        valeur: 'Jolof Teranga — GIE sénégalais de plantes médicinales et produits naturels'),
                    const SizedBox(height: 12),
                    _LigneInfo(icone: Icons.calendar_today_outlined, label: 'Date de collecte',
                        valeur: 'Juin 2026'),
                    const SizedBox(height: 12),
                    _LigneInfo(icone: Icons.inventory_2_outlined, label: 'Produits documentés',
                        valeur: 'Poudre de Nep-Nep · Thé Wass · Feuilles de Nguer · Poudre de Baobab · Huile de Baobab · Huile de Neem'),
                  ],
                ),
              ),
              const SizedBox(height: 30),
              const Center(
                child: Text('ESMT · Licence 3 · 2026',
